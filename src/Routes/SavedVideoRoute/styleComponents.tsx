...
export const SavedVideoPage = styled.div`
  background-color: ${(props: SavedVideoStyle) =>
...
export const SavedVideoEmptyContainer = styled.div`
  ...
  text-align: center;
  min-height: 80vh;
  color: ${(props: SavedVideoStyle) => (props.darkMode ? "white" : "#231f20")};
...
export const SavedVideoHeaderContainer = styled.div`
  color: ${(props: SavedVideoStyle) => (props.darkMode ? "white" : "#181818")};
